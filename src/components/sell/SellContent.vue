<template>
	<div id="sell-content">
		<el-row :gutter="20">
			...
			<el-col :span="4">
				<div class="sell-grid">
					<div class="row-text">Name:</div>
					<div class="row-text">Source:</div>
					<div class="row-text">Price:</div>
					<div class="row-text">Inventory:</div>
					<div class="row-text">Category:</div>
					<div class="row-text">ImageSrc:</div>
					<div class="row-text">Description:</div>
				</div>
			</el-col>
			<el-col :span="8">
				<el-form class="sell-grid" v-model="model" @submit.native.prevent="send">
					...
					<div class="row-size">
						<el-input placeholder="請簡單描述" v-model="model.Description" type="textarea" maxlength="50" :rows="4" show-word-limit resize="none" />
					</div>
